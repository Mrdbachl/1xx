...
function init() {
	...
	$.ajax({
		method: 'GET',
		url: 'https://me.dbachl.com/wp-json/wp-api-menus/v2/menus/2',
		dataType: 'json',
...
$.ajax({
		method: 'GET',
		url: 'https://me.dbachl.com/wp-json/wp-api-menus/v2/menus/3',
		dataType: 'json',
		success: function (data) {
...
function getPage(obj) {
	...
	$.ajax({
		method: 'GET',
		url: 'https://me.dbachl.com/wp-json/wp/v2/pages/' + obj,
		dataType: 'json',
		success: function (data) {
			var pgbuild = '';
